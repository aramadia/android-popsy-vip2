...
// dalam: commented most of this file since were on osx now.
...
OSSAudioDriver::OSSAudioDriver(MP3AudioProvider* prv) {
//     this->prov = prv;
...
// #else
//     this->set_ioctl(SNDCTL_DSP_SETFMT, AFMT_S16_BE);
// #endif
...
inline void OSSAudioDriver::set_ioctl(int command, int value) {
    // if (ioctl(this->oss_fd, command, &value) == -1) {
