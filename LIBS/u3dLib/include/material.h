...
public:
    ...
    void SetShading(U32 shad)                                  {
        Shading=shad;
    }
    void SetSpecular(bool b)                                   {
        SpecularShading=b;
    }
    void SetRouge(Ufloat d)                                    {
        RVBA[0]=d;
    }
    void SetVert(Ufloat d)                                 {
        RVBA[1]=d;
    }
    void SetBleu(Ufloat d)                                 {
        RVBA[2]=d;
    }
    void SetAlpha(Ufloat d)                                    {
        RVBA[3]=d;
    }
    ...
    void SetTex1Pos(Ufloat u, Ufloat v, Ufloat du, Ufloat dv)  {
        Xstart1=u;
        Ystart1=v;
        Xdelta1=du;
        Ydelta1=dv;
    }
    void SetTex2Pos(Ufloat u, Ufloat v, Ufloat du, Ufloat dv)  {
        Xstart2=u;
        Ystart2=v;
        Xdelta2=du;
        Ydelta2=dv;
    ...
    U32         GetTrTex1()                                                     {
        return Transparence1;
    }
    void        GetTex1Pos(Ufloat& sx, Ufloat& sy, Ufloat& dx, Ufloat& dy) {
        sx=Xstart1;
        sy=Ystart1;
        dx=Xdelta1;
        dy=Ydelta1;
    ...
    U32         GetTrTex2()                                                     {
        return Transparence2;
    }
    void        GetTex2Pos(Ufloat& sx, Ufloat& sy, Ufloat& dx, Ufloat& dy) {
        sx=Xstart2;
        sy=Ystart2;
        dx=Xdelta2;
        dy=Ydelta2;
