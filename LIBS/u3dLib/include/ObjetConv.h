...
public:
    ...
    U16     GetCoordIndex(Coord3DConv* c)   {
        return c->num;
    }
    ...
    U16             GetVertexIndex(VertexU3DConv* v)    {
        return v->num;
    }
    ...
    U16             GetFaceIndex(PolygonU3DConv* f) {
        return f->num;
    }
    void            DoWrapping();
    ...
    U8          GetmatIndex(MaterialU3DConv* m)    {
        return m->num;
    }
