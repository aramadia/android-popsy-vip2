...
public:
    ...
    void ConsProRota(bool b)    {
        ProportionRotation=b;
    }
    void PipeSet(bool b)       {
        b? FlagStatus&=~flagNoPipeset : FlagStatus|=flagNoPipeset;
    }
    ...
    bool IsEnable()         {
        return FlagStatus&flagDisable ? FALSE : TRUE;
    }
    bool IsInterpoAlpha()   {
        return FlagStatus&interpoAlpha ? TRUE : FALSE;
    }
    bool IsInterpoXPos()    {
        return FlagStatus&interpoXpos ? TRUE : FALSE;
    }
    bool IsInterpoYPos()    {
        return FlagStatus&interpoYpos ? TRUE : FALSE;
    }
    bool IsInterpoAngle()   {
        return FlagStatus&interpoAngle ? TRUE : FALSE;
    }
