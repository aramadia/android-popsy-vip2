...
public:
    ...
    Ufloat GetXpos()        {
        return tab[0]->GetXpos();
    }
    Ufloat GetYpos()        {
        return tab[0]->GetYpos();
    }
    Ufloat GetXSize()       {
        return tab[0]->GetXSize();
    }
    Ufloat GetYSize()       {
        return tab[0]->GetYSize();
    }
    Ufloat GetXZoom()       {
        return tab[0]->GetXZoom();
    }
    Ufloat GetYZoom()       {
        return tab[0]->GetYZoom();
    }

    void SetFactAlpha(Ufloat a)        {
        factAlpha=a;
    }
    void SetFacttimeAlpha(Ufloat a)    {
        facttimeAlpha=a;
    }
    void SetFactXpos(Ufloat a)     {
        facttimeXPos=a;
    }
    void SetFactYpos(Ufloat a)     {
        facttimeYPos=a;
    }
    void SetFactXZoom(Ufloat a)        {
        facttimeXZoom=a;
    }
    void SetFactYZoom(Ufloat a)        {
        facttimeYZoom=a;
    }
    void SetFactAngle(Ufloat a)        {
        facttimeAngle=a;
    }
